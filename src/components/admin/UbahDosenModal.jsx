// components/admin/UbahDosenModal.jsx
import { useState } from "react";
import { useFormik } from "formik";
import { fakultasData } from "../../data/fakultasData";
import { dosenEditSchema } from "../../schemas/dosenSchema";
import Input from "../ui/Input";
import SearchableSelect from "../ui/SearchableSelect";
import ConfirmSaveModal from "./ConfirmSaveModal";

export default function UbahDosenModal({ isOpen, onClose, onSuccess, data }) {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      status_persetujuan: data.status_persetujuan || "Disetujui",
    },
    validationSchema: dosenEditSchema,
  ...
  return (
    <>
      ...
      <ConfirmSaveModal
        ...
        description={`Data dosen ${data.nama_lengkap} akan diperbarui. Apakah Anda yakin ingin menyimpan perubahan ini?`}
      />
      ...
      <div className="fixed inset-0 z-[998] flex items-center justify-center bg-black/30 backdrop-blur-sm p-4">
        <div className="bg-white rounded-2xl w-full max-w-[500px] shadow-xl overflow-hidden">
          ...
          <div className="overflow-y-auto max-h-[80vh]">
            <form onSubmit={formik.handleSubmit} id="ubah-dosen-form">
